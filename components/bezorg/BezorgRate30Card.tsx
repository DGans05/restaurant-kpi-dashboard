...
interface BezorgRate30CardProps {
  summary: BezorgSummary;
}

export function BezorgRate30Card({ summary }: BezorgRate30CardProps) {
  return (
    <div className={cn(cardStyles, "animate-fade-up animate-lift stagger-1")}>
