      ...
      <div className="hidden md:flex flex-1 max-w-md mx-8">
        <div className="relative w-full">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full rounded-full border border-border bg-secondary/50 pl-10 pr-4 py-2 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
          />
        </div>
      </div>
